      ...
      >
        ...
        <div className="mb-8">
          ...
          <p className="text-slate-500 font-medium text-sm">
            Sign in to access your dashboard. (Type 'parent' or 'mentor' in email to test roles)
          </p>
        </div>
        ...
        <form className="space-y-5" onSubmit={handleLogin}>
          ...
          <button type="submit" className="w-full py-4 mt-4 bg-[#3b82f6] hover:bg-blue-600 text-white font-bold text-lg rounded-xl shadow-[0_4px_14px_rgba(59,130,246,0.4)] hover:shadow-[0_6px_20px_rgba(59,130,246,0.5)] hover:-translate-y-0.5 transition-all">
            Sign In
          </button>
        </form>
